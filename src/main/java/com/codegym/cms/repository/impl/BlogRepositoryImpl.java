...
//Tao query va function chinh
@Transactional //further research
public class BlogRepositoryImpl implements BlogRepository {

    @PersistenceContext
    private EntityManager em; //Khai bao entity manager
    ...
    public Blog findById(Long id) {
        ...
        query.setParameter("id",id); //set de truyen id vao dieu kien cua Query
        try {
